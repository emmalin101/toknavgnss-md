...
const roMessages: Record<string, string> = {
  ...
  "Admin Accounts": "Conturi admin",
  "Add a second login account, reset passwords or remove accounts you no longer need.": "Adăugați un al doilea cont de autentificare, resetați parole sau eliminați conturile de care nu mai aveți nevoie.",
  "New admin email": "Email admin nou",
  "Temporary password": "Parolă temporară",
  "Add Admin": "Adaugă admin",
  "Reset Password": "Resetează parola",
  "Delete this admin user?": "Ștergeți acest cont admin?",
  "Admin user created.": "Cont admin creat.",
  "Admin password updated.": "Parola admin a fost actualizată.",
  "Admin user deleted.": "Cont admin șters.",
  "Admin creation failed.": "Crearea contului admin a eșuat.",
  "Admin password reset failed.": "Resetarea parolei admin a eșuat.",
  "Admin deletion failed.": "Ștergerea contului admin a eșuat.",
